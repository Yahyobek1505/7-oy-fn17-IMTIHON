  ...
  return (
    <div className="flex justify-between gap-4 max-w-[296px]">
      <div className="flex gap-[20px] place-items-center bg-paleSilver mx-auto px-6">
        <button
          type="button"
          className="opacity-[50%] py-2 focus:outline-none "
          onClick={handleDecrement}
        >
          -
        </button>
        <input
          className="bg-paleSilver py-4 w-8 text-center text-black focus:outline-none text-subtitle"
          type="number"
          min="1"
          value={quantity}
        ...
        <button
          type="button"
          className="opacity-[50%] py-4 focus:outline-none "
      ...
      <button
        className="bg-brightOrange hover:bg-brightOrangeHover transition-colors duration-300 uppercase text-subtitle text-pureWhite px-[30px] py-[20px] max-w-[220px] "
